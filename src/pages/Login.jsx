  ...
  return (
    <div style={s.page}>
      ...
      <div className="login-container" style={s.container}>
        ...
        <div className="login-left" style={s.leftSide}>
        ...
        <div className="login-right" style={s.rightSide}>
          <div className="login-card" style={s.loginCard}>

            {/* Mobile logo */}
            <div className="mobile-logo" style={s.mobileLogo}>
...
const s = {
  ...
  loginCard: { 
    ...
    boxShadow: '0 0 0 1px rgba(79,70,229,0.15),0 20px 60px rgba(0,0,0,0.5),0 0 80px rgba(79,70,229,0.08)', 
